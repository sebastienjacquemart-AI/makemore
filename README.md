...
*Convolution layer: These are similar to linear layers, but used for images. They have spatial structure and thus basically perform the linear multiplication on overlapping patches iso the full input
